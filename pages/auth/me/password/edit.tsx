        ...
        async (data) => {
            try {
                ...
                const response = await authAPI.put(
                    "auth/user/password", data
                );

                toast().success("Wow!", response.data ? response.data.message : 'Atualizado')
                    .with({
                        duration: 4000,
                        speed: 1000,
                        positionX: 'end',
                                ...
                                <div className="px-4 py-5 bg-white sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-3">
                                            <Input name='current_password' label='Senha atual' type="password"
                                        ...
                                        <div className="col-span-6 sm:col-span-3">
                                            <Input name='password_confirmation' label='Confirmação da nova senha'
                                                   type="password"
