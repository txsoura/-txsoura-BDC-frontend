...
const Index = () => {
    ...
    const getItem = useCallback(async () => {
        try {
            const response = await serviceAPI.get(`constructions/${id}`);
        ...
        <>
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg mt-1 ml-2 mr-2">
                <div className="px-4 py-5 sm:px-6">
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Ccnstrução</h3>
                ...
                <div className="border-t border-gray-200">
                    <dl>
                        ...
                        <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{user.budget}</dd>
                        </div>
                        {/*<div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">*/}
