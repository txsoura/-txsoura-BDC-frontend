...
const Index = () => {
    ...
    const create: SubmitHandler<CompanyProps> = useCallback(
        async (data) => {
            try {
            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    <img
                        ...
                        alt="Workflow"
                    />
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Faça o cadastro, e controle
                        as suas construções facilmente</h2>
