...
const companyAddressEditSchema = Yup.object().shape({
    ...
    postcode: Yup.string().max(255, 'Este campo deve ter no máximo 255 caracteres'),
    number: Yup.string().max(255, 'Este campo deve ter no máximo 255 caracteres'),
    complement: Yup.string().max(255, 'Este campo deve ter no máximo 255 caracteres'),
    ...
    country: Yup.string().max(255, 'Este campo deve ter no máximo 255 caracteres'),
    district: Yup.string().max(255, 'Este campo deve ter no máximo 255 caracteres'),
});
