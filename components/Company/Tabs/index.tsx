                                                ...
                                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div className="mt-2">
                                                        <p className="text-sm text-gray-500">
                                                            Tem certeza, que pretende bloquear essa construtora? Ela
                                        ...
                                        {modalType === "approve" && (
                                            <>
                                                ...
                                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div className="mt-2">
                                                        <p className="text-sm text-gray-500">
                                                            Tem certeza, que pretende aprovar essa construtora?
                                                        </p>
                                                    </div>
                                                </div>
                                            </>
            ...
            <div className="border-t border-gray-200">
                <dl>
                    ...
                    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{typeSwitch(company.type)}</dd>
                    </div>
                    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt className="text-sm font-medium text-gray-500">Cpf/Cnpj</dt>
                        <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{company.tax}</dd>
                    </div>
                    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt className="text-sm font-medium text-gray-500">Área de trabalho</dt>
                        <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                            <div
                                className="text-xs inline-flex items-center font-bold leading-sm lowercase px-3 py-1 bg-blue-200 text-blue-700"
                            >
                                <svg className="fill-current w-3 h-3 mx-1" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 320 512">
                                    <path
